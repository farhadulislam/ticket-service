...
public class Constants {
    ...
    public static final class ErrorMessages{
        ...
        public static final String ERROR_EMPTY_TICKET_REQUEST = "Ticket request can't be empty";
        public static final String ERROR_TICKET_REQUEST_NULL = "Ticket request must be initialized or not null";
